...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(dense)
        ...
        if(!no_code)
        {
            ...
            Vector coding;
            //Vector sift_descriptors(keypoints.size()*128);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if(port_out_sift.getOutputCount())
            {
                port_out_sift.setEnvelope(stamp);
                Vector sift_descriptors(128*keypoints.size());
                for (unsigned int i=0; i<keypoints.size(); i++)
                    for (int j=0; j<128; j++)
                        sift_descriptors[i*128+j] = descriptors[i*128+j];
                // verificare come dumpa (descriptors vettore di n_keypoints x 128 con n_keypoints ignoto)
                port_out_sift.write(sift_descriptors);
            }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
       ...
       :BufferedPort<Image>(),rf(_rf)
   {
        ...
        string dictionary_name=rf.check("dictionary_file",Value("dictionary_sc.ini")).asString().c_str();
        ...
        for(int i=0; i<code_mode_string.size(); i++)
            ...
            code_mode_string[i] = toupper((unsigned char)code_mode_string[i]);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
        port_out_sift.open(("/"+name+"/sift:o").c_str());
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
