...
if (WIN32)
    ...
    FIND_PATH(SIFTGPU_INCLUDE_DIRS NAMES GL/glut.h PATHS ${SIFTGPU_DIR})
    FIND_LIBRARY(SIFTGPU_LIBRARIES_GLUT NAMES glut.lib glut32.lib PATHS ${SIFTGPU_DIR}/lib)
	FIND_LIBRARY(SIFTGPU_LIBRARIES_SIFTGPU NAMES SIFTGPU.lib PATHS ${SIFTGPU_DIR}/lib)
	SET(SIFTGPU_LIBRARIES ${SIFTGPU_LIBRARIES_GLUT} ";" ${SIFTGPU_LIBRARIES_SIFTGPU})
	...
	if (SIFTGPU_INCLUDE_DIRS AND SIFTGPU_LIBRARIES)
...
message(STATUS "SIFTGPU_FOUND - " ${SIFTGPU_FOUND})
if (SIFTGPU_FOUND)
